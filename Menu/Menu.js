...
/*
  ...
  Step 3: Using a DOM selector, select the menu button (the element with a
    class of 'menu-button') currently on the DOM.
...
btn.append(menuMaker(menuItems));